...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, default="./datasets/training_data/Manuel_Pellegrini/%04d.jpg")
    
    # Hint: For each known class set the label to the name of the class (e.g. "Peter Gilmour").
